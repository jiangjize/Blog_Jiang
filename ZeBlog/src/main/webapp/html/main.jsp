...
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            <div class="ht-console">
                <div class="ht-user">
                    ...
                    <a class="ht-user-name">超级管理员：<%=name%></a>
                </div>
            </div>
            <span class="sys-title">博客管理系统</span>
            <ul class="ht-nav">
            ...
            <div class="layui-side-scroll">
                <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                           <%-- <dd><a href="javascript:;" data-url="datalist.html" data-id="1">文章管理</a></dd>
                            ...
                            <dd><a href="javascript:;" data-url="<%=path%>/BlogServlet" data-id="1">博客列表</a></dd>
                            <dd><a href="javascript:;" data-url="<%=path%>/html/addblog.jsp" data-id="2">添加博客</a></dd>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="<%=path%>/html/datalist.jsp" data-id="4">全部用户</a></dd>
        ...
        <div class="layui-footer">
            <p style="line-height:44px;text-align:center;">博客管理系统 - Design By LY</p>
        </div>
        <!--快捷菜单-->
